...
class StoryOneViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.storyTxt.alpha = 0.0
        self.continueTxt.alpha = 0.0
        playMusic()
    ...
    @objc func checkAction(sender : UITapGestureRecognizer) {
        self.performSegue(withIdentifier: "story_2", sender: self)
    }
    ...
    func playMusic() {
        guard let path = Bundle.main.path(forResource: "Story", ofType: "mp3") else { return }
